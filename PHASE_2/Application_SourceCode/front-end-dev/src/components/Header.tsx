        ...
        return (
            <Navbar className="App-theme" variant="dark" expand="lg">
                ...
                <Nav className="mr-auto">
                    <Nav.Link><Link to="/search" className="link" onClick={() => sessionStorage.clear()}>Search</Link></Nav.Link>
                    <Nav.Link><Link to="/analyze" className="link" onClick={() => sessionStorage.clear()}>Analyze</Link></Nav.Link>
                    <Nav.Link href={this.state.api_doc_url} onClick={() => sessionStorage.clear()}>API</Nav.Link>
                </Nav>
            </Navbar>
        );
    }
